...
function Room({ code, token }: { code: string; token: string }) {
  const socket = useNineToOneSocket(code, token);
...
function Lobby({ socket, view }: { socket: NineToOneSocket; view: RoomView }) {
...
function LobbyChat({ socket, view }: { socket: NineToOneSocket; view: RoomView }) {
