...
Usage (depuis backend/, pour le .env) : .venv/bin/python ../ml/check_obs_parity2.py
"""
...
from app.botbrain import Memory, obs_mask, snapshot_from_state, snapshot_from_view  # noqa: E402
...
def main(games=300):
    ...
    for g in range(games):
        game = Game(g)
        room = Room(code="0000", state=game.state)
