...
ML = "/home/defint/projects/nine_to_one/ml"
...
class V1Adapter:
    ...
    def act(self, game):
        from app.engine.state import Comparator
...
def main():
    ...
    ap.add_argument("--v1", default="/home/defint/projects/nine_to_one/ml/bot_policy_v1.npz")
    args = ap.parse_args()
